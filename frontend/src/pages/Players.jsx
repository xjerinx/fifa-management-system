      ...
      <div className="flex flex-col gap-2.5 pt-1">
        ...
        <div className="flex flex-col xl:flex-row xl:items-center justify-between gap-4">
          <h1 className="text-2xl sm:text-3xl lg:text-4xl font-black text-white tracking-tight uppercase leading-tight font-display">
            REGISTERED PLAYERS & SCOUTING HUB
          </h1>
        ...
        <p className="text-xs sm:text-sm text-slate-400 font-normal max-w-3xl">
          {items.length} professional athletes registered across international federations with complete contract, biometric tracking, and real-time market valuations.
        </p>
      </div>
